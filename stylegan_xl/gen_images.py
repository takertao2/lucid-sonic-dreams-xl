...
@click.option('--outdir',
              ...
              required=True,
              metavar='DIR')
def generate_images(network_pkl: str, seeds: List[int], batch_sz: int,
                    truncation_psi: float, centroids_path: str,
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        PIL.Image.fromarray(gen_utils.create_image_grid(img),
